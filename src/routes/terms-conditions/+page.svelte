...
<section class="section user-profile">
	...
	<div class="analytics-header">
		<div class="header-top">
			<h1>Terms and Conditions Preview</h1>
			<!-- Correctly displays the full name -->
		</div>
	</div>
	<!-- Divider -->
	<hr class="divider" />
	...
	<div class="container">
		...
		<section class="content">
			...
			<p class="content">
				We operate the website <a href="https://www.thrivehub.ai">https://www.thrivehub.ai</a>(the
				<strong> "Site" </strong>) , the mobile application Thrive Hub (the
				<strong> "App" </strong>), as well as any other related products and services that refer or
				link to these legal terms (the <strong> "Legal Terms" </strong>) (collectively, the
				<strong> "Services"</strong>).
			</p>

			<p class="content">
				You can contact us by phone at (+1)4084202526, email at <a href="mailto:Ops@thrivehub.ai"
					>Ops@thrivehub.ai</a
			...
			<p class="content">
				...
				personally or on behalf of an entity (<strong> "you" </strong>), and Thrive Hub, concerning
				your access to and use of the Services. You agree that by accessing the Services, you have
			...
			<p class="content">
				...
				using. The modified Legal Terms will become effective upon posting or notifying you by <a
					href="mailto:Ops@thrivehub.ai">Ops@thrivehub.ai</a
			...
			<ul>
				...
				<li>
					...
					access, solely for your internal business purpose.
				</li>
			</ul>
			...
			<p class="content">
				...
				transmit, publish, distribute, or broadcast content and materials to us or through the
			...
			<p class="content">
				By sending us Submissions and/or posting Contributions through any part of the Services or
			...
			<h4>We may remove or edit your Content:</h4>

			<p class="content">
				Although we have no obligation to monitor any Contributions, we shall have the right to
				remove or edit any Contributions at any time without notice if in our reasonable opinion we
				consider such Contributions harmful or in breach of these Legal Terms. If we remove or edit
				any such Contributions, we may also suspend or disable your account and report you to the
				authorities.
			</p>
			...
			<p class="content">
				...
				subject to availability, and we cannot guarantee that items will be in stock. We reserve the
			...
			<h3>Free Trial</h3>
			<p class="content">
				We offer a 30-day free trial to new users who register with the Services. The account will
			...
			<p class="content">
				...
				solely in connection with our services and in accordance with these Legal Terms.
			</p>
			<p class="content">
				Any software and any related documentation is provided "AS IS" without warranty of any kind,
			...
			<h2 id="user-generated-contributions">11. USER GENERATED CONTRIBUTIONS</h2>
			<p class="content">
				The Services may invite you to chat, contribute to, or participate in blogs, message boards,
...
<h2 id="guidelines-for-reviews">13. GUIDELINES FOR REVIEWS</h2>
<p class="content">
...
<h2 id="mobile-application-license">14. MOBILE APPLICATION LICENSE</h2>
<h3>Use License</h3>
<p class="content">
...
<h2 id="contribution-license">15. SOCIAL MEDIA</h2>
<p class="content">
...
(if applicable) any content that you have provided to and stored in your ThirdParty Account (the "Social Network Content") so that it is available on and
...
the Services. Please note that if a Third-Party Account or associated service
...
may no longer be available on and through the Services. You will have the
ability to disable the connection between your account on the Services and
...
any purpose, including but not limited to, for accuracy, legality, or noninfringement, and we are not responsible for any Social Network Content.
...
<h2 id="contribution-license">16. THIRD-PARTY WEBSITES AND CONTENT</h2>
<p class="content">
...
Services and access the Third-Party Websites or to use or install any ThirdParty Content, you do so at your own risk, and you should be aware these
...
by your purchase of such products or services. Additionally, you shall hold us
...
<h2 id="contribution-license">17. ADVERTISERS</h2>
<p class="content">
...
and we have no other relationship with advertisers
  ...
  <h2 id="services-management">18. SERVICES MANAGEMENT</h2>
<p class="content">
...
<h2 id="privacy-policy">19. PRIVACY POLICY</h2>
<p class="content">
...
<h2 id="term-and-termination">20. TERM AND TERMINATION</h2>
<p class="content">
...
<h2 id="modifications-and-interruptions">21. MODIFICATIONS AND INTERRUPTIONS</h2>
<p class="content">
...
<h2 id="dispute-resolution">23. DISPUTE RESOLUTION</h2>
...
<h2 id="governing-law">24. CORRECTIONS</h2>
<p class="content">
...
<h2 id="contribution-license">25. DISCLAIMER</h2>
<p class="content">THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE
...
<h2 id="contribution-license">26. LIMITATIONS OF LIABILITY</h2>
<p class="content">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR
  ...
  PRIOR TO ANY CAUSE OF ACTION ARISING OR $2,500.00
...
<h2 id="contribution-license">27. INDEMNIFICATION</h2>
<p class="content">You agree to defend, indemnify, and hold us harmless, including our
  ...
  third party, including but not limited to intellectual property rights; or (6) any
...
<h2 id="contribution-license">28. USER DATA</h2>
<p class="content">We will maintain certain data that you transmit to the Services for the purpose
...
<h2 id="contribution-license"> 29. ELECTRONIC COMMUNICATIONS,
  TRANSACTIONS, AND SIGNATURES</h2>
<p class="content">Visiting the Services, sending us emails, and completing online forms
  ...
  <h2 id="sms-text-messaging">30. SMS TEXT MESSAGING</h2>
  <h3>Opting Out</h3>
  <p class="content">
  ...
  <h3>Support</h3>
  <p class="content">
    If you have any questions or need assistance regarding our SMS communications, please email us at Ops@thrivehub.ai or call at (+1)4084202526.
  </p>
  

<h2 id="contribution-license">31. CALIFORNIA USERS AND RESIDENTS</h2>
<p class="content">If any complaint with us is not satisfactorily resolved, you can contact the
...
<h2 id="contribution-license">32. MISCELLANEOUS</h2>
<p class="content">These Legal Terms and any policies or operating rules posted by us on the
  ...
  hereto to execute these Legal Terms.</p>


  <h2 id="contact-us">33. CONTACT US</h2>
  <p class="content">
    In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:
  </p>
  <p class="content"><strong>
    Thrive Hub<br>
    2600 Michelson Dr #1500<br>
    Irvine, CA 92612<br>
    United States<br>
    Phone: (+1)4084202526<br>
    ops@thrivehub.ai
  </strong> 
  </p>
