    ...
    <!-- Now we will use Divider -->
     ...
     <div class="class container">
        ...
        <section class="content">
            ...
            <p class="content">Thrive Hub is licensed to You (End-User) by Thrive Hub AI, located at 2600
                Michelson Dr #1500, Irvine, __________ 92612, United States <strong>("Licensor")</strong>,
                for use only under the terms of this License Agreement.</p>
            ...
            <p class="content">
                ...
                this License Agreement, and that You accept this License Agreement. App
            ...
            <p class="content">
                he parties of this License Agreement acknowledge that the Services are not
                ...
                maintenance and support thereof. Thrive Hub AI, not the Services, is solely
            ...
            <p class="class content">
                hrive Hub when purchased or downloaded through the Services, is licensed
                to You for use only under the terms of this License Agreement. The Licensor
                reserves all rights not expressly granted to You. Thrive Hub is to be used on
            ...
            <div class="class table-of-content">
				...
				<a href="#maintenance-and-support">4. MAINTENANCE AND SUPPORT</a><br />
				<a href="#use-of-data">5. USE OF DATA</a><br />
				<a href="#user-generated-contributions">6. USER-GENERATED CONTRIBUTIONS</a><br />
				<a href="#contribution-license">7. CONTRIBUTION LICENSE</a><br />
				<a href="#liability">8. LIABILITY</a><br />
				<a href="#warranty">9. WARRANTY</a><br />
				<a href="#product-claims">10. PRODUCT CLAIMS</a><br />
				<a href="#legal-compliance">11. LEGAL COMPLIANCE</a><br />
				<a href="#contact-information">12. CONTACT INFORMATION</a><br />
				<a href="#termination">13. TERMINATION</a><br />
				<a href="#third-party-terms-of-agreements-and-beneficiary">14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</a><br />
				<a href="#intellectual-property-rights">15. INTELLECTUAL PROPERTY RIGHTS</a><br />
				<a href="#application-law">16. APPLICATION LAW</a><br />
				<a href="#miscellaneous">17. MISCELLANEOUS</a><br />

            </div>
            <h2 id="the-application">1. THE APPLICATION</h2>

            <p class="class content">
                Thrive Hub <strong>("Licensed Application")</strong> is a piece of software created to
                Facilate business reviews for businesses and to provide affiliates services
                and offers to users. — and customized for iOS and Android mobile devices
                <strong>("Devices").</strong> It is used to Collect user reviews and provide services. .
            </p>
            ...
            <h2 id="scope-of-license">2. SCOPE OF LICENSE</h2>
            ...
            <p class="class content">
                ...
                Licensed Application, unless a separate license is provided for such update,
            ...
            <p class="class content">
                ...
                parties (unless to the degree allowed by the Usage Rules, and with Thrive
                Hub AI's prior written consent), sell, rent, lend, lease or otherwise redistribute
            ...
            <p class="class content">
                ...
                any part thereof (except with Thrive Hub AI's prior written consent).
            </p>
            ...
            <p class="class content">
                ...
                unauthorized third parties may gain access to these copies at any time. If you
            ...
            <p class="class content">
                ...
                When using the Licensed Application, You must ensure that You comply with
                applicable third-party terms and conditions.
            </p>
            <h2 id="technical-requirement">3. TECHNICAL REQUIREMENTS</h2>

            <p class="class content">
                .1 Licensor attempts to keep the Licensed Application updated so that it
            ...
            <h2 id="maintenance-and-support">4. MAINTENANCE AND SUPPORT</h2>
            ...
            <p class="class content">
                4.2 Thrive Hub AI and the End-User acknowledge that the Services have no
            ...
            <p class="class content">
                ...
                that Licensor's use of such material and information is subject to Your legal
                agreements with Licensor and Licensor's privacy policy, which can be found
                at the bottom of the Licensed Application.
            </p>
            ...
            <p class="class content">
               ...
               updates, and for purposes of providing other services to you (if any) related
               to the Licensed Application. Licensor may also use this information to
               improve its products or to provide services or technologies to you, as long as
            ...
            <p class="class content">
                The Licensed Application may invite you to chat, contribute to, or participate
                ...
                perform, publish, distribute, or broadcast content and materials to us or in the
                Licensed Application, including but not limited to text, writings, video, audio,
                ...
                by other users of the Licensed Application and through third-party websites
                or applications. As such, any Contributions you transmit may be treated as
            ...
            <ul>
                ...
                <li>
                    ...
                    violates, any provision of this License Agreement, or any applicable law or
                    regulation.
                </li>
            </ul>
            ...
            <p class="class content">
                ...
                broad cast, retitle, archive, store, cache, publicly display, reformat, translate,
            ...
            <p class="class content">
                ...
                otherwise change any Contributions; (2) to recategorize any Contributions to
                place them in more appropriate locations in the Licensed Application; and (3)
                to prescreen or delete any Contributions at any time and for any reason,
            ...
            <p class="class content">
                ...
                liable in case of slight negligence. In any case, liability shall be limited to the
            ...
            <p class="class content">
                ...
                by third parties, or if there are any other reasons outside of Thrive Hub AI's
            ...
            <p class="class content">
                ...
                installing it and notify Thrive Hub AI about issues discovered without delay by
                email provided in <a href="#contact-number">Contact Information</a>. The defect report will be taken into
                consideration and further investigated if it has been emailed within a period of
                ninety (90) days after discovery.
            </p>

            <p class="class content">
                9.4 If we confirm that the Licensed Application is defective, Thrive Hub AI
            ...
            <p class="class content">
                ...
                Application, and any other losses, claims, damages, liabilities, expenses, and
            ...
            <h2 id="product-claims">10. PRODUCT CLAIMS</h2>

            <p class="class content">
                Thrive Hub AI and the End-User acknowledge that Thrive Hub AI, and not the
                Services, is responsible for addressing any claims of the End-User or any
                third party relating to the Licensed Application or the End-User’s possession
            ...
            <h2 id="legal-compliance">11. LEGAL COMPLIANCE</h2>
            ...
            <ul>
                <li>Senior Devops</li>
                <li>2600 Michelson Dr #1500</li>
                <li>Irvine, __________ 92612</li>
                <li>United States</li>
                <li>ops@thrivehub.ai</li>
            </ul>

            <h2 id="termination">13. TERMINATION</h2>

            <p class="class content">
                The license is valid until terminated by Thrive Hub AI or by You. Your rights
                under this license will terminate automatically and without notice from Thrive
                Hub AI if You fail to adhere to any term(s) of this license. Upon License
                termination, You shall stop all use of the Licensed Application, and destroy all
                copies, full or partial, of the Licensed Application.
            </p>

            <h2 id="third-party-terms-of-agreements-and-beneficiary">14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</h2>

            <p class="class content">
                Thrive Hub AI represents and warrants that Thrive Hub AI will comply with
            ...
            <h2 id="intellectual-property-rights">15. INTELLECTUAL PROPERTY RIGHTS</h2>

            <p class="class content">
                Thrive Hub AI and the End-User acknowledge that, in the event of any thirdparty claim that the Licensed Application or the End-User's possession and
                use of that Licensed Application infringes on the third party's intellectual
                property rights, Thrive Hub AI, and not the Services, will be solely
                responsible for the investigation, defense, settlement, and discharge or any
                such intellectual property infringement claims.
            </p>

            <h2 id="appliciable-law">16. APPLICABLE LAW</h2>
            <p class="class content">
